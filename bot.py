...
def send_start(client, message):
    bot.send_message(
        ...
        text=f"👋 مرحبا {message.from_user.mention},\n\n بوت حفظ مقيد.. \n\n البوت ما ينزل ستوريات بس من القنوات المقيدة.",
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("قناتي", url="https://t.me/K1KKK5")],
            [InlineKeyboardButton("يوزري", url="https://t.me/Aelexon")]
        ]),
...
def save(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	if "https://t.me/+" in message.text or "https://t.me/joinchat/" in message.text:
		...
		if acc is None:
			bot.send_message(message.chat.id,f"**صار خطأ**", reply_to_message_id=message.id)
			return
		...
		try:
			...
			bot.send_message(message.chat.id,"**رابط مايشتغل**", reply_to_message_id=message.id)
